...
export const en: Dict = {
  ...
  'resources.filters': 'Resource filters',
  'resources.results': 'Resource results',
  'resources.inspector': 'Preview inspector',
  'resources.showFilters': 'Show filters',
  'resources.closeFilters': 'Close filters',
  'resources.showInspector': 'Show preview inspector',
  'resources.closeInspector': 'Close preview inspector',
  'resources.preview': 'Preview',
  'resources.all': 'All',
  'resources.favorites': 'Favorites',
  'resources.unsorted': 'Unsorted',
  'resources.types': 'Types',
  'resources.sources': 'Sources',
  'resources.collections': 'Collections',
  'resources.newCollection': 'New collection',
  'resources.newCollectionName': 'New collection name',
  'resources.createCollection': 'Create collection',
  'resources.selectPrompt': 'Select a resource',
  'resources.selectPromptDetail': 'Its local preview, source, and metadata will stay available here.',
  'resources.previewMissing': 'Preview not captured',
  'resources.previewMissingDetail': 'This reference keeps its provenance without embedding the external page.',
  'resources.fullscreen': 'Open fullscreen preview',
  'resources.previous': 'Previous resource',
  'resources.next': 'Next resource',
  'resources.favoriteAdd': 'Add to favorites',
  'resources.favoriteRemove': 'Remove from favorites',
  'resources.dimensions': 'Dimensions',
  'resources.size': 'Size',
  'resources.captured': 'Captured',
  'resources.storage': 'Storage',
  'resources.storageLocal': 'Local preview',
  'resources.storageReference': 'Reference only',
  'resources.tags': 'Tags',
  'resources.displayName': 'Display name',
  'resources.notes': 'Notes',
  'resources.saveDetails': 'Save details',
  'resources.useInDesign': 'Use in design',
  'resources.openProject': 'Open project',
  'resources.openSource': 'Open source',
  'resources.inspectFullscreen': 'Open fullscreen to inspect this resource.',
  'resources.list': 'List',
  'resources.batchTag': 'Batch tag',
  'resources.tagSelection': 'Tag selection',
  'resources.addTag': 'Add tag',
  'resources.favoriteSelection': 'Favorite',
  'resources.addToCollection': 'Add to collection…',
  'resources.operationFailed': 'The resource operation failed. Try again.',
  'resources.partialFailure': '{count} selected resource operations failed.',
  'resources.resultCount': '{count} resources',
  'resources.activeFilters': 'Active filters',
  'resources.removeFilter': 'Remove filter',
  'resources.sort': 'Sort resources',
  'resources.sortNewest': 'Newest first',
  'resources.sortOldest': 'Oldest first',
  'resources.sortTitle': 'Title',
  'resources.sortKind': 'Type',
  'resources.exportSelection': 'Export selected',
  'resources.exportingSelection': 'Exporting…',
  'resources.exportPartial': '{count} selected resources could not be exported.',
  'resources.sourceClipper': 'Clipper',
  'resources.sourceUpload': 'Uploads',
  'resources.sourceAgent': 'Agent',
  'resources.sourceDesignSystem': 'Design systems',
  'resources.sourceGenerated': 'Generated',
  'resources.kindImage': 'Images',
  'resources.kindElement': 'Elements',
  'resources.kindDesignSystem': 'Design systems',
  'resources.kindVideo': 'Video',
  'resources.kindHtml': 'HTML',
  'resources.kindFont': 'Fonts',
  'resources.kindColor': 'Colors',
  'resources.kindText': 'Text',
  'resources.kindUrl': 'Links',

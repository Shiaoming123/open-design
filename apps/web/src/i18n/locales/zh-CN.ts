...
export const zhCN: Dict = {
  ...
  "resources.title": "资源",
  "resources.workspace": "工作台",
  "resources.filters": "资源筛选",
  "resources.results": "资源结果",
  "resources.inspector": "预览检查器",
  "resources.showFilters": "显示筛选",
  "resources.closeFilters": "关闭筛选",
  "resources.showInspector": "显示预览检查器",
  "resources.closeInspector": "关闭预览检查器",
  "resources.preview": "预览",
  "resources.all": "全部",
  "resources.favorites": "收藏",
  "resources.unsorted": "未归类",
  "resources.types": "类型",
  "resources.sources": "来源",
  "resources.collections": "集合",
  "resources.newCollection": "新建集合",
  "resources.newCollectionName": "新集合名称",
  "resources.createCollection": "创建集合",
  "resources.selectPrompt": "选择一个资源",
  "resources.selectPromptDetail": "本地预览、来源和元数据会持续显示在这里。",
  "resources.previewMissing": "尚未采集预览",
  "resources.previewMissingDetail": "此条目只保留来源证据，不嵌入外部页面。",
  "resources.fullscreen": "打开全屏预览",
  "resources.previous": "上一个资源",
  "resources.next": "下一个资源",
  "resources.favoriteAdd": "加入收藏",
  "resources.favoriteRemove": "取消收藏",
  "resources.dimensions": "尺寸",
  "resources.size": "大小",
  "resources.captured": "采集时间",
  "resources.storage": "存储",
  "resources.storageLocal": "本地预览",
  "resources.storageReference": "仅引用",
  "resources.tags": "标签",
  "resources.displayName": "显示名称",
  "resources.notes": "备注",
  "resources.saveDetails": "保存详情",
  "resources.useInDesign": "用于设计",
  "resources.openProject": "打开项目",
  "resources.openSource": "打开来源",
  "resources.inspectFullscreen": "打开全屏以检查此资源。",
  "resources.list": "列表",
  "resources.batchTag": "批量标签",
  "resources.tagSelection": "为所选项添加标签",
  "resources.addTag": "添加标签",
  "resources.favoriteSelection": "收藏",
  "resources.addToCollection": "加入集合…",
  "resources.operationFailed": "资源操作失败，请重试。",
  "resources.partialFailure": "有 {count} 个所选资源操作失败。",
  "resources.resultCount": "{count} 个资源",
  "resources.activeFilters": "当前筛选",
  "resources.removeFilter": "移除筛选",
  "resources.sort": "资源排序",
  "resources.sortNewest": "最新优先",
  "resources.sortOldest": "最早优先",
  "resources.sortTitle": "标题",
  "resources.sortKind": "类型",
  "resources.exportSelection": "导出所选",
  "resources.exportingSelection": "正在导出…",
  "resources.exportPartial": "有 {count} 个所选资源无法导出。",
  "resources.sourceClipper": "网页剪藏",
  "resources.sourceUpload": "上传",
  "resources.sourceAgent": "智能体",
  "resources.sourceDesignSystem": "设计体系",
  "resources.sourceGenerated": "生成内容",
  "resources.kindImage": "图片",
  "resources.kindElement": "元素",
  "resources.kindDesignSystem": "设计体系",
  "resources.kindVideo": "视频",
  "resources.kindHtml": "HTML",
  "resources.kindFont": "字体",
  "resources.kindColor": "颜色",
  "resources.kindText": "文本",
  "resources.kindUrl": "链接",
